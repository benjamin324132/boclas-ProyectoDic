        ...
        <List>
          ...
          >
            <ListItem
              ...
              key={2}
              selected={
                window.location.pathname === "/dashboard/casos" ? true : false
              }
            >
              <ListItemIcon>
                <GavelIcon />
          ...
          >
            <ListItem
              ...
              key={3}
              selected={
                window.location.pathname === "/dashboard/asignado"
                  ? true
                  : false
              }
            >
          ...
          >
            <ListItem
              ...
              key={4}
              selected={
                window.location.pathname === "/dashboard/reportes"
                  ? true
                  : false
              }
            >
          ...
          >
            <ListItem
              ...
              key={5}
              selected={
                window.location.pathname === "/dashboard/configuracion"
                  ? true
                  : false
              }
            >
          ...
          >
            <ListItem
              ...
              key={6}
              selected={
                window.location.pathname === "/dashboard/catalogos"
                  ? true
                  : false
              }
            >
